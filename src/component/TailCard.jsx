...
export default function TailCard({title, info, imgsrc, kwds}) {
        ...
        <div className='border-1 border-gray-200 shadow-xl'>
            {
                imgsrc 
                ? 
                <div className='flex justify-center items-center h-55 overflow-hidden'>
                    <img onError={(e) => onImageError(e)} src={imgsrc} className="object-contain"/>
                </div>
                : ""
            }
